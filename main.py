"""Module implements character creation"""
...
def attack(char_name: str, char_class: str) -> str:
    ...
    return ('Не удалось нанести урон противнику')
...
def defence(char_name: str, char_class: str) -> str:
    ...
    return ('Не удалось защититься от противника')


def special(char_name: str, char_class: str) -> str:
    """Special perk function."""
    if char_class == 'warrior':
        return (
    ...
    return ('Не удалось применить специальное умение')
